...
if(isset($_POST['submit'])){
  ...
  $ssc = stripslashes($_POST['ssc']);
   ...
   $result_hsc = stripslashes($_POST['result_hsc']);
   $result_hsc = mysqli_real_escape_string($conn, $result_hsc);
  ...
  $brc = mysqli_real_escape_string($conn, $brc);
    ...
    $query = "INSERT INTO accountant (name, mother_name, father_name, nid, ssc, result_ssc, hsc,  result_hsc, phone, email, brc) VALUES ('$name', '$mother_name', '$father_name', '$nid', '$ssc', '$result_ssc', '$hsc', '$result_hsc', '$phone', '$email', '$brc')";
...
<head>
  ...
  <title>Appointment - INSTITUTE OF EDUCATION</title>
  ...
  <div class="accordion-item">
    <h2 class="accordion-header " id="panelsStayOpen-headingThree">
      <button class="accordion-button collapsed justify-content-center" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseThree" aria-expanded="false" aria-controls="panelsStayOpen-collapseThree">
       <span class="text-bg-warning"><strong>Accountant Application Form.</strong> <a class="btn btn-danger btn-sm" href="#"> Click Here </a></span>
      </button>
    </h2>
        ...
        <div class="col-lg-6">
          <div class="card">
            <div class="card-header bg-danger">
              <div class="card-title text-center text-light"><h2>Accountant Application Form</h2></div>
            </div>
            <div class="card-body">
            <form action="" method="post">
                ...
                <div class="mb-3">
                  ...
                  <!-- result -->
                  Result 
                  <select name="result_hsc" id=""class="form-control">
                    <option value="">Select Result</option>
                  <option value="A+">A+</option>
                  <option value="A">A</option>
                  <option value="A-">A-</option>
              ...
              <div class="mb-3">
                ...
                <strong><a href="https://mail.google.com/">insedubd23@gmail.com</a></strong>
                <p>Thank you</p>
              </div>
