...
<head>
  ...
  <title>Events - INSTITUTE OF EDUCATION</title>
...
<body>
  ...
  <main id="main">
    ...
    <div class="breadcrumbs" data-aos="fade-in">
      <div class="container">
        <h2>Events</h2>
        <p>We organise some Educational events... </p>
      </div>
    </div><!-- End Breadcrumbs -->
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          <div class="col-md-6 d-flex align-items-stretch">
            <div class="card">
              <div class="card-img">
                <img src="assets/img/backpack.jpg" alt="...">
              </div>
              <div class="card-body">
                <h5 class="card-title"><a href="">Celebrating national Backpacks Day.</a></h5>
          ...
          <div class="col-md-6 d-flex align-items-stretch">
            <div class="card">
              <div class="card-img">
                <img src="assets/img/study tour.jpg" alt="...">
              </div>
              <div class="card-body">
                <h5 class="card-title"><a href="">Study Tour from Institute of Education</a></h5>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            ...
            <p>
             parbatipur Upazilla  <br>
              Dinajpur<br>
              Bangladesh <br><br>
              <strong>Phone:</strong> +88 01710000000<br>
          ...
          <div class="col-lg-4 col-md-6 footer-newsletter">
            ...
            <p>Share your Valuable Opinioon</p>
